...
(function () {
      ...
      on: {
        error: function (response) {
          if (_this.url.substring(0, 4) !== 'http') {
            ...
            return _this.fail('Can\'t read api-docs JSON from ' + _this.url);
          } else {
  ...
  SwaggerApi.prototype.buildFrom1_1Spec = function (response) {
    log("This API is using a deprecated version of Swagger!  Please see http://github.com/wordnik/api-docs-core/wiki for more info");
    if (response.apiVersion != null)
      this.apiVersion = response.apiVersion;
    this.apis = {};
    this.apisArray = [];
