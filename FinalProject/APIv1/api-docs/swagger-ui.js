...
(function() {
  ...
  SwaggerUi = (function(_super) {
    ...
    SwaggerUi.prototype.initialize = function(options) {
      ...
      return this.headerView.on('update-api-docs-ui', function(data) {
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.showPetStore = function(e) {
      return this.trigger('update-api-docs-ui', {
        url: "http://petstore.api-docs.wordnik.com/api/api-docs"
      });
    };
    ...
    MainView.prototype.initialize = function(opts) {
      ...
      if (this.model.swaggerVersion === "2.0") {
        if ("validatorUrl" in opts.swaggerOptions) {
          ...
          return this.model.validatorUrl = "http://online.api-docs.io/validator";
        }
      }
    };
